...
// */
//
//#ifndef HAL_DC_MOTOR_STATIC_INC_MOTORPROXY_H_
//#define HAL_DC_MOTOR_STATIC_INC_MOTORPROXY_H_
//
//
...
//
//Motor_DirectionType* MotorProxy_accessMotorDirection(MotorProxy* const me);
//
...
//void MotorProxy_writeMotorSpeed(MotorProxy* const me, const Motor_DirectionType* direction, unsigned int speed);
//
//MotorProxy * MotorProxy_Create(void);
//void MotorProxy_Destroy(MotorProxy* const me);
//
//#endif /* HAL_DC_MOTOR_STATIC_INC_MOTORPROXY_H_ */
