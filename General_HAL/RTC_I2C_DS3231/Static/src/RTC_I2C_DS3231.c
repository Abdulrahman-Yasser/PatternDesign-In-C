...
void RTC_DS3231_Init(void){
    uint8 data;
    I2C_MasterPoke_to_receive(RTC_DS3231_I2C_Channel, RTC_DS3231_I2C_Slave_Address, RTC_DS3231_Control_Register, 1);
    I2C_Pop_the_Received(RTC_DS3231_I2C_Channel, &data, 1) ;
    if(data & 0x80 ){
        /* OSC is stopped */
        return;
...
uint16 RTC_DS3231_ReadTemperature(void ){
    ...
    I2C_MasterPoke_to_receive(RTC_DS3231_I2C_Channel, RTC_DS3231_I2C_Slave_Address, RTC_DS3231_TempMSB_Register, 2);
...
RTC_DS3231_TimeFrame RTC_DS3231_ReadTime_and_Date(void){
    ...
    do{
        I2C_MasterPoke_to_receive(RTC_DS3231_I2C_Channel, RTC_DS3231_I2C_Slave_Address, RTC_DS3231_Seconds_Register, 1);
        data[0] = I2C_Pop_the_Received(RTC_DS3231_I2C_Channel, data, 1);
        data[0] = BCD_to_DECI(data[0]);
    }while(data[0] == 59);
    I2C_MasterPoke_to_receive(RTC_DS3231_I2C_Channel, RTC_DS3231_I2C_Slave_Address, RTC_DS3231_Seconds_Register, 6);
...
RTC_DS3231_TimeFrame RTC_DS3231_ReadTime(void){
    ...
    I2C_MasterPoke_to_receive(RTC_DS3231_I2C_Channel, RTC_DS3231_I2C_Slave_Address, RTC_DS3231_Seconds_Register, 3);
...
RTC_DS3231_TimeFrame RTC_DS3231_ReadDate(void){
    ...
    I2C_MasterPoke_to_receive(RTC_DS3231_I2C_Channel, RTC_DS3231_I2C_Slave_Address, RTC_DS3231_Date_Register, 4);
