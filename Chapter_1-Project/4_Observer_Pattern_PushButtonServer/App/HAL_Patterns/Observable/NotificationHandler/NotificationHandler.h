...
#ifndef APP_HAL_PATTERNS_OBSERVABLE_NOTIFICATIONHANDLER_NOTIFICATIONHANDLER_H_
#define APP_HAL_PATTERNS_OBSERVABLE_NOTIFICATIONHANDLER_NOTIFICATIONHANDLER_H_
...
#endif /* APP_HAL_PATTERNS_OBSERVABLE_NOTIFICATIONHANDLER_NOTIFICATIONHANDLER_H_ */
