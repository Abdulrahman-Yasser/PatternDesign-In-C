...
#ifndef APP_WEATHERSTATION_MODULE_WEATHERSTATION_MODULE_H_
#define APP_WEATHERSTATION_MODULE_WEATHERSTATION_MODULE_H_
...
#endif /* APP_WEATHERSTATION_MODULE_WEATHERSTATION_MODULE_H_ */
